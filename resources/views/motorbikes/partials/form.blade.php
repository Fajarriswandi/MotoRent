...
<div class="headerForm">
    <div class="content container">
        <div>
            <h4>{{ isset($motorbike) ? 'Edit' : 'Add' }} your Vehicle for Rental</h4>
            <p>Please fill in all tht details.</p>
        </div>
        <div>
            <div class="mt-4 d-flex justify-content-between">
                <a href="{{ route('motorbikes.index') }}" class="btn btn-outline-secondary me-3">Cancel</a>
                <button type="submit" class="btn btn-primary" id="submitBtn">
                    <span class="spinner-border spinner-border-sm d-none" id="submitSpinner" role="status"
                        aria-hidden="true"></span>
                    <span id="submitText">{{ isset($motorbike) ? 'Confirm & Update' : 'Confirm & Submit' }}</span>
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="brand" value="{{ old('brand', $motorbike->brand ?? '') }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="model" value="{{ old('model', $motorbike->model ?? '') }}"
                        class="form-control" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="year" value="{{ old('year', $motorbike->year ?? '') }}"
                        class="form-control" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="color" value="{{ old('color', $motorbike->color ?? '') }}"
                        class="form-control" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="license_plate"
                        value="{{ old('license_plate', $motorbike->license_plate ?? '') }}" class="form-control"
                        required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    @if($isRented)
                        ...
                        <select id="technical_status" class="form-select" disabled>
                            <option value="active" {{ $motorbike->technical_status == 'active' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="inactive" {{ $motorbike->technical_status == 'inactive' ? 'selected' : '' }}>Tidak
                                Aktif</option>
                            <option value="maintenance" {{ $motorbike->technical_status == 'maintenance' ? 'selected' : '' }}>
                                Perawatan</option>
                        </select>
